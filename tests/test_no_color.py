...
class TestNoColorFlag:
    """Tests for --patterns-no-color command-line flag."""

    def test_no_color_flag_disables_ansi_codes(self) -> None:
...
"""
        ...
        assert "·" in stderr, (
            f"Expected whitespace marker '·' in stderr:\n{stderr}"
        )

    def test_no_color_flag_preserves_whitespace_markers(self) -> None:
...
class TestColorEnabledByDefault:
    """Tests for color being enabled by default."""

    def test_color_auto_disabled_in_non_tty(self) -> None:
...
'''
    ...
    def test_color_flag_overrides_tty_detection(self) -> None:
...
class TestShouldUseColorFunction:
    """Unit tests for _should_use_color helper function."""

    def test_flag_disables_color(self) -> None:
    ...
    def test_no_flag_no_env_tty_check(self) -> None:
...
class TestWhitespaceReportsWithoutColor:
    """Test whitespace reporting works correctly without colors."""

    def test_whitespace_only_line_visible_without_color(self) -> None:
...
'''
    ...
    def test_trailing_whitespace_visible_without_color(self) -> None:
...
class TestFormatLineReportWithColor:
    """Unit tests for format_line_report with color control."""

    def test_whitespace_with_color_enabled(self) -> None:
    ...
    def test_whitespace_with_color_disabled(self) -> None:
    ...
    def test_trailing_whitespace_with_color_disabled(self) -> None:
    ...
    def test_tabs_with_color_disabled(self) -> None:
...
class TestAuditReportWithColor:
    """Unit tests for Audit.report() with color control."""

    def test_audit_report_no_color(self) -> None:
    ...
    def test_audit_report_with_color(self) -> None:
    ...
    def test_audit_report_no_color_mixed_whitespace(self) -> None:
    ...
    def test_audit_report_no_color_refused_lines(self) -> None:
